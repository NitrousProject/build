...
""" % bcb_dev)
  ...
  script.Print("                                                                                             s/` ")    
  script.Print("                      .:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::://dms. ")   
  script.Print("                      :yyyyyyyyyyyyyyyhhhhhhhhhhhhhhhhhhhhhhhhhdddddddddddddddddddddddmmmmmmmmmmd/` ") 
  script.Print("                      :yyyyyyyyyyyyyyyhhhhhhhhhhhhhhhhhhhhhhhhddddddddddddddddddddddddmmmmmmmmmmmm/ ") 
  script.Print("   ``````             :yyyyyyy:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::mdmmh: ") 
  script.Print("   sssssss:`          :yyyyyh:    .:+osyyhhhyyso+:`      -osyyyyyyyyyyyyyy/yyyyyyyyhhhhhhys/`hmo` ")   
  script.Print("   syyyyyyys/`        :yyyyyh: `/syyhhhyo+//+syhhhhs/`  /hhhhdddyyyyyyyyyy+hddddddyyyydmmmmmy+- ")     
  script.Print("   syyyyyyoyyy+.      :yyyyyh::yyyyhhy-       `/hhhhhh/ yhhhddd-          `hdddddh`   /mmmmmm+  ")     
  script.Print("   syyyyys`.+yyyo-    :syyyyh/yyyyhhy`          :hhhhhh:/hhhdddo//:////:` `hddddhho++odmmmmmm-  ")     
  script.Print("   syyyyy-   ./syyo:  `:yyyyh+yyyhyh+           -h+hhhho :yhdddddd+dddddh+`hddddyydddddddddy-  ")      
  script.Print("   oysyys`     `/ssh+::-yysh/-+yyhshs.         .sy:yhyh.   `....-s:hhyhsdd/ydydhy``````````  ")        
  script.Print("  :y+oo/.       `:+:y::so:y`  :+h:y/+.`     -./h/:ss..  `..`.`` /:ys+h.dd+:d+yoo`  ")                 
  script.Print("   `y++`            `- `s..s     -./` // +`.-os+-  .`    -yhoso+. `y.:o +o`.d++`  ")                   
  script.Print("    :..                 -` -          `- --  :-.          ./.---   -``-    `/-. ")    
